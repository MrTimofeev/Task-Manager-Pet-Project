...
def task_detail(request, pk):
    ...
    if task.user != request.user:  # Проверяем, что задача принадлежит текущему пользователю
...
def task_create(request, project_id):
    ...
    if project.user != request.user:  # Проверяем, что проект принадлежит текущему пользователю
